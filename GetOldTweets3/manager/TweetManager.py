...
class TweetManager:
	...
	@staticmethod
	def getTweets(tweetCriteria, receiveBuffer=None, bufferLength=100, proxy=None, debug=False, state=True):
        ...
        state: bool, determine if the main program is currently executing or has been interrupted
        """
		results = []
		resultsAux = []
